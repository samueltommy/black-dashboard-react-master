...
const SettingsBabyService = {
    settingsbaby: async (payload, config) => {
        ...
        if (matchingObject) {
            ...
            const redirectUrl = `https://staging-antro.srv.kirei.co.id/baby/${idFromUserId}`;
...
export default SettingsBabyService;