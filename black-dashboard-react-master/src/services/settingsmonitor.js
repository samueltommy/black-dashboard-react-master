...
const SettingsMonitorService = {
    settingsmonitor: async (payload, config) => {
        const userId = localStorage.getItem('id');

        const respon = await fetch('https://staging-antro.srv.kirei.co.id/monitoring', config)
        ...
        if (matchingObject) {
            ...
            const redirectUrl = `https://staging-antro.srv.kirei.co.id/monitoring/${idFromUserId}`;
...
export default SettingsMonitorService;