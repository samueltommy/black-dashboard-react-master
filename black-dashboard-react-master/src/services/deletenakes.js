...
const DeleteNakesService = {
    deletenakes: async (payload, config) => {
        ...
        if (userId) {
            ...
            const redirectUrl = `https://staging-antro.srv.kirei.co.id/nakes/${userId}`;
...
export default DeleteNakesService;
