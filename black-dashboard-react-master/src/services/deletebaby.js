...
const DeleteBabyService = {
    deletebaby: async (payload, config) => {
        ...
        if (userId) {
            ...
            const redirectUrl = `https://staging-antro.srv.kirei.co.id/baby/${userId}`;
...
export default DeleteBabyService;
