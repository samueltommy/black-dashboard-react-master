...
const MonitorAnakService = {
    monitoranak: async (payload, config) => {
        ...
        if (matchingObject) {
            ...
            const response = await apiClient.get(redirectUrl, payload, config);
...
export default MonitorAnakService;