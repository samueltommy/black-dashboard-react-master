...
const DeleteMonitorService = {
    deletemonitor: async (payload, config) => {
        ...
        if (userId) {
            ...
            const redirectUrl = `https://staging-antro.srv.kirei.co.id/monitor/${userId}`;
...
export default DeleteMonitorService;
